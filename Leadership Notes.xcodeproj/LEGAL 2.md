...
- **Support Page**: `https://YOUR-USERNAME.github.io/leadership-notes/support.html`
...
4. Add URLs:
   - **Support URL**: `https://YOUR-USERNAME.github.io/leadership-notes/support.html`
   - **Privacy Policy URL**: `https://YOUR-USERNAME.github.io/leadership-notes/privacy-policy.html`
   - **Terms of Service URL**: `https://YOUR-USERNAME.github.io/leadership-notes/terms-of-service.html` (if required)
   - **Marketing URL** (optional): `https://YOUR-USERNAME.github.io/leadership-notes/`
...
Link(destination: URL(string: "https://YOUR-USERNAME.github.io/leadership-notes/support.html")!)
...
- **support.html** - Support page with FAQs, troubleshooting, and contact info
...
- `SettingsView.swift` (Legal & Support section)
...
The `support.html` page includes:
- ✅ Quick start guide
